$(document).ready(function(){
    ...
    var settings =  '<a id="settings" href="#changeSkin" data-toggle="modal">' +
        ...
        '<img src="http://localhost:8080/blog-web/static/img/skin-violate.jpg" alt="">' +
        '</a>' +
        '<a data-skin="skin-blur-lights" class="col-sm-2 col-xs-4" href="">' +
        '<img src="http://localhost:8080/blog-web/static/img/skin-lights.jpg" alt="">' +
        '</a>' +
        '<a data-skin="skin-blur-city" class="col-sm-2 col-xs-4" href="">' +
        '<img src="http://localhost:8080/blog-web/static/img/skin-city.jpg" alt="">' +
        '</a>' +
        '<a data-skin="skin-blur-greenish" class="col-sm-2 col-xs-4" href="">' +
        '<img src="http://localhost:8080/blog-web/static/img/skin-greenish.jpg" alt="">' +
        '</a>' +
        '<a data-skin="skin-blur-night" class="col-sm-2 col-xs-4" href="">' +
        '<img src="http://localhost:8080/blog-web/static/img/skin-night.jpg" alt="">' +
        '</a>' +
        '<a data-skin="skin-blur-blue" class="col-sm-2 col-xs-4" href="">' +
        '<img src="http://localhost:8080/blog-web/static/img/skin-blue.jpg" alt="">' +
        '</a>' +
        '<a data-skin="skin-blur-sunny" class="col-sm-2 col-xs-4" href="">' +
        '<img src="http://localhost:8080/blog-web/static/img/skin-sunny.jpg" alt="">' +
        '</a>' +
        '<a data-skin="skin-cloth" class="col-sm-2 col-xs-4" href="">' +
        '<img src="http://localhost:8080/blog-web/static/img/skin-cloth.jpg" alt="">' +
        '</a>' +
        '<a data-skin="skin-tectile" class="col-sm-2 col-xs-4" href="">' +
        '<img src="http://localhost:8080/blog-web/static/img/skin-tectile.jpg" alt="">' +
        '</a>' +
        '<a data-skin="skin-blur-chrome" class="col-sm-2 col-xs-4" href="">' +
        '<img src="http://localhost:8080/blog-web/static/img/skin-chrome.jpg" alt="">' +
        '</a>' +
        '<a data-skin="skin-blur-ocean" class="col-sm-2 col-xs-4" href="">' +
        '<img src="http://localhost:8080/blog-web/static/img/skin-ocean.jpg" alt="">' +
        '</a>' +
        '<a data-skin="skin-blur-sunset" class="col-sm-2 col-xs-4" href="">' +
        '<img src="http://localhost:8080/blog-web/static/img/skin-sunset.jpg" alt="">' +
        '</a>' +
        '<a data-skin="skin-blur-yellow" class="col-sm-2 col-xs-4" href="">' +
        '<img src="http://localhost:8080/blog-web/static/img/skin-yellow.jpg" alt="">' +
        '</a>' +
        '<a  data-skin="skin-blur-kiwi"class="col-sm-2 col-xs-4" href="">' +
        '<img src="http://localhost:8080/blog-web/static/img/skin-kiwi.jpg" alt="">' +
        '</a>' +
        '</div>' +
        '</div>' +
        '</div>' +
